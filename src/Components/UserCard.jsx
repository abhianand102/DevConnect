...
const UserCard = ({user}) => {
    const {_id,firstName, lastName, age, gender, skill, photoURL, about}=user;
...
// I hava to update the to new updated feed as soon as i hit the  intrested or ignore button